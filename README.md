...
|---------|-------|-------------|
| [schema-agnostic-clustering-agent](https://github.com/jarpaivan-wq/schema-agnostic-clustering-agent) | Claude Sonnet 5 + Haiku 4.5 · scikit-learn · pandas | Schema-agnostic clustering workflow — profiles any CSV/Excel/SQLite dataset dynamically and clusters it through a deterministic pipeline, no schema mapping required. Validated end-to-end on 3 unrelated real domains (a simulated debt-collection portfolio, real phosphoproteomics data, and the classic Iris dataset); thresholds calibrated against ground truth (ARI 0.979), grown through 8 real bugs found and fixed across two major versions — full history in the CHANGELOG. |
...
| Project | Stack | Description |
|---------|-------|-------------|
| [collections-performance-dashboard](https://github.com/jarpaivan-wq/collections-performance-dashboard) | SQLite · Pandas · Power BI | End-to-end collections analytics pipeline |
| [collection-etl-pipeline](https://github.com/jarpaivan-wq/collection-etl-pipeline) | MySQL · CTEs · Window Functions | Automated ETL for debt collection management |
| [multi-report-etl-pipeline](https://github.com/jarpaivan-wq/multi-report-etl-pipeline) | MySQL · CTEs · Multi-output | 3 operational reports from a single pipeline |
| [ecommerce-sql-analysis](https://github.com/jarpaivan-wq/ecommerce-sql-analysis) | MySQL | Customer segmentation · Sales trends |
